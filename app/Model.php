...
class Model
{
    ...
    public function buscarCombinada($nombre, $energia)
    {
        $nombre = htmlspecialchars($nombre);
        $energia = htmlspecialchars($energia);

        $sql = "select * from alimentos where nombre like '" . $nombre . "' AND energia = " . $energia . " order by nombre";
