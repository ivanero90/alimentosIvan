...
class Controller
{
    ...
    public function buscarAlimentosCombinada()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            $params['nombre'] = $_POST['nombre'];
            $params['energia'] = $_POST['energia'];
            $params['resultado'] = $m->buscarCombinada($_POST['nombre'], $_POST['energia']);
        }

        require __DIR__ . '/templates/busquedaCombinada.php';
    }

    public function alimentosWikipedia()
    {
        $params = array(
            'nombre' => '',
            'resultado' => array(),
        ...
        $params['resultado'] = $m->alimentosWiki();

        require __DIR__ . '/templates/mostrarAlimentosWiki.php';
    }
